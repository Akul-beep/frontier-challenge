    ...
    <>
      {placeholder ? (
        <Image
          ...
          sizes="100vw"
          alt="Background"
          className={cn(className, "absolute inset-0", { invisible: videoLoaded })}
          quality={100}
          fill
        />
      ) : null}
      <video
        ...
        controls={false}
        preload="auto"
        className={cn(className, "absolute inset-0 w-full h-full", { invisible: !videoLoaded })}
...
export const Background = ({
  ...
  const classNames = "bg-background object-cover";
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0">
      <Image
        ...
        src={src}
        alt="Background"
        className={cn(classNames, "absolute inset-0 w-full h-full")}
        sizes="100vw"
        fill
      />
    </div>
